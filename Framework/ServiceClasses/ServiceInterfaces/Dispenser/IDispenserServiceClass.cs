...
{
    public interface IDispenserService : ICashManagementService, ICommonService
    {
        /// <summary>
    ...
    public interface IDispenserServiceClass : IDispenserService, IDispenserUnsolicitedEvents
    {
    }
}
