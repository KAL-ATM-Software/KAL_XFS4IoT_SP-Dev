...
namespace XFS4IoTFramework.Common
{
    public sealed class CardReaderStatusClass
    {
        ...
        /// </summary>
        public CardReaderStatusClass()
        {
            Media = MediaEnum.Unknown;
            Security = SecurityEnum.NotSupported;
            ChipPower =  ChipPowerEnum.NotSupported;
            ChipModule = ChipModuleEnum.NotSupported;
            MagWriteModule = MagWriteModuleEnum.NotSupported;
            FrontImageModule = FrontImageModuleEnum.NotSupported;
            BackImageModule = BackImageModuleEnum.NotSupported; ;
        }
