 ...
 * DepleteEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class DepleteEvents : CashAcceptorEvents, IDepleteEvents
    {

        public DepleteEvents(IConnection connection, int requestId)
        ...
        public async Task IncompleteDepleteEvent(XFS4IoT.CashAcceptor.Events.IncompleteDepleteEvent.PayloadData Payload) => await connection.SendMessageAsync(new XFS4IoT.CashAcceptor.Events.IncompleteDepleteEvent(requestId, Payload));
