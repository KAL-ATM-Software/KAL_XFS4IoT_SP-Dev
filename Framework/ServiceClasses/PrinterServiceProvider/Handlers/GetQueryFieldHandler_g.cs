...
namespace XFS4IoTFramework.Printer
{
    ...
    public partial class GetQueryFieldHandler : ICommandHandler
    {
        ...
        public async Task Handle(object command, CancellationToken cancel)
        {
            ...
            await Connection.SendMessageAsync(new GetQueryFieldCompletion(getQueryFieldCmd.Header.RequestId.Value, result.Payload, result.CompletionCode, result.ErrorDescription));
        ...
        public async Task HandleError(object command, Exception commandException)
        {
            ...
            var response = new GetQueryFieldCompletion(getQueryFieldCommand.Header.RequestId.Value, null, errorCode, commandException.Message);
