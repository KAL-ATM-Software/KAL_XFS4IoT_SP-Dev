...
namespace XFS4IoT.KeyManagement.Completions
{
    ...
    {
        public DeriveKeyCompletion(int RequestId, DeriveKeyCompletion.PayloadData Payload, MessageHeader.CompletionCodeEnum CompletionCode, string ErrorDescription)
