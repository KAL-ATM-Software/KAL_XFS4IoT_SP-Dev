...
{
    //Original name = SetCashUnitInfo
    [DataContract]
    [Command(Name = "CashManagement.SetCashUnitInfo")]
    public sealed class SetCashUnitInfoCommand : Command<SetCashUnitInfoCommand.PayloadData>
    {
        public SetCashUnitInfoCommand(int RequestId, SetCashUnitInfoCommand.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(int Timeout, Dictionary<string, CashunitsClass> Cashunits = null)
                : base(Timeout)
            {
