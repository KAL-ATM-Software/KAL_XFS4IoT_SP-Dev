...
{
    public interface IBanknoteNeutralizationDevice : IDevice
    {
        /// <summary>
        ...
        /// </summary>
        Task<SetProtectionResult> SetProtectionAsync(SetProtectionRequest request, CancellationToken cancellation);
        ...
        /// </summary>
        Task<TriggerNeutralizationResult> TriggerNeutralizationAsync(TriggerNeutralizationRequest request, CancellationToken cancellation);
