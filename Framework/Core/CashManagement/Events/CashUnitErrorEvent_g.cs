...
namespace XFS4IoT.CashManagement.Events
{
    ...
    [DataContract]
    [Event(Name = "CashManagement.CashUnitErrorEvent")]
    public sealed class CashUnitErrorEvent : Event<CashUnitErrorEvent.PayloadData>
    {

        public CashUnitErrorEvent(int RequestId, PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayloadBase
        {
            ...
            public PayloadData(FailureEnum? Failure = null, CashUnitClass CashUnit = null)
                : base()
            {
            ...
            public CashUnitClass CashUnit { get; private set; }
