...
namespace XFS4IoT.CashAcceptor.Completions
{
    ...
    public sealed class CashInRollbackCompletion : Completion<CashInRollbackCompletion.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(CompletionCodeEnum CompletionCode, string ErrorDescription, ErrorCodeEnum? ErrorCode = null, Dictionary<string, CashunitsClass> Cashunits = null)
            ...
            /// 
            /// "shutterNotOpen": Shutter failed to open. In the case of explicit shutter control the application may have failed to open the shutter before issuing the command.
            /// 
