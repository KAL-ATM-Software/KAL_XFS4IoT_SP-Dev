...
namespace XFS4IoT.CardReader.Commands
{
    ...
    public sealed class EjectCardCommand : Command<EjectCardCommand.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            /// <summary>
            /// Specifies the destination of the card ejection for motorized card readers. Possible values are one of
            /// the following:
            /// 
            /// * ```exitPosition``` - The card will be transferred to the exit slot from where the user can remove
            ///   it. In the case of a latched dip the card will be unlatched, enabling removal.
            /// * ```transportPosition``` - The card will be transferred to the transport just behind the exit slot.
            ///   If a card is already at this position then *success* will be returned. Another
