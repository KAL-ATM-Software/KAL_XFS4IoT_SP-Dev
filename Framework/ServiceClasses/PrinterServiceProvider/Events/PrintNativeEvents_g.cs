 ...
 * PrintNativeEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class PrintNativeEvents : PrinterEvents, IPrintNativeEvents
    {

        public PrintNativeEvents(IConnection connection, int requestId)
