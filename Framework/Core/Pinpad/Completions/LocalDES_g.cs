...
namespace XFS4IoT.PinPad.Completions
{
    ...
    {
        public LocalDESCompletion(int RequestId, LocalDESCompletion.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            /// * ```invalidKeyLength``` - The length of keyEncKey is not supported or the length of an encryption key is not compatible with 
            /// the encryption operation required.
            /// </summary>
