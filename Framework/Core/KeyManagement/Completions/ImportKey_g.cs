...
namespace XFS4IoT.KeyManagement.Completions
{
    ...
    public sealed class ImportKeyCompletion : Completion<ImportKeyCompletion.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(CompletionCodeEnum CompletionCode, string ErrorDescription, ErrorCodeEnum? ErrorCode = null, List<byte> VerificationData = null, VerifyAttributesClass VerifyAttributes = null, int? KeyLength = null)
            ...
            /// loaded key with the same name as key.
            ...
            /// * ```signatureNotSupported``` - The *cryptoMethod* of the *verifyAttributes* is not supported. The key is
            /// not stored in the device.
            /// * ```signatureInvalid``` - The verification data in the input data is invalid. The key is not stored in
            /// the device.
            ...
            /// 
            /// This property can be omitted if there is no verification data.
            ...
            /// 
            /// This property should be omitted if there is no verification data.
            /// </summary>
