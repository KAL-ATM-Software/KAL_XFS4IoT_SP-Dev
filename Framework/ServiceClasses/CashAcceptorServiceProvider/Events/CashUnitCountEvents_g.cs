 ...
 * CashUnitCountEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class CashUnitCountEvents : CashAcceptorEvents, ICashUnitCountEvents
    {

        public CashUnitCountEvents(IConnection connection, int requestId)
