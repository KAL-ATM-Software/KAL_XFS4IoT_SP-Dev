...
namespace XFS4IoT.TextTerminal.Completions
{
    ...
    {
        public LoadFormCompletion(int RequestId, LoadFormCompletion.PayloadData Payload, MessageHeader.CompletionCodeEnum CompletionCode, string ErrorDescription)
