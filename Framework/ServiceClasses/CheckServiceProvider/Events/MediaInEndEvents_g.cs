 ...
 * MediaInEndEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class MediaInEndEvents : CheckEvents, IMediaInEndEvents
    {

        public MediaInEndEvents(IConnection connection, int requestId)
