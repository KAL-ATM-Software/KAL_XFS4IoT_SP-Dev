 ...
 * DataEntryEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class DataEntryEvents : KeyboardEvents, IDataEntryEvents
    {

        public DataEntryEvents(IConnection connection, int requestId)
