...
namespace XFS4IoTFramework.KeyManagement
{
    ...
    public partial class DeriveKeyHandler : ICommandHandler
    {
        ...
        public async Task Handle(object command, CancellationToken cancel)
        {
            ...
            await Connection.SendMessageAsync(new DeriveKeyCompletion(deriveKeyCmd.Header.RequestId.Value, result.Payload, result.CompletionCode, result.ErrorDescription));
        ...
        public async Task HandleError(object command, Exception commandException)
        {
            ...
            var response = new DeriveKeyCompletion(deriveKeyCommand.Header.RequestId.Value, null, errorCode, commandException.Message);
