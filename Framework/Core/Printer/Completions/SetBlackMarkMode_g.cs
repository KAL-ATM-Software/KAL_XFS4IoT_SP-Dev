...
namespace XFS4IoT.Printer.Completions
{
    ...
    {
        public SetBlackMarkModeCompletion(string RequestId, SetBlackMarkModeCompletion.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            {
                ErrorDescription.IsNotNullOrWhitespace($"Null or an empty value for {nameof(ErrorDescription)} in received {nameof(SetBlackMarkModeCompletion.PayloadData)}");
