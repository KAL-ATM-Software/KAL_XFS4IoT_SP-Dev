...
namespace XFS4IoTFramework.Common
{
    ...
    {
        public SynchronizeCommandHandler(IConnection Connection, ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            this.Connection = Connection.IsNotNull($"Invalid parameter in the {nameof(SynchronizeCommandHandler)} constructor. {nameof(Connection)}");
        }
