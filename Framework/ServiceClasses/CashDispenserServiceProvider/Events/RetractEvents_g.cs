...
{
    internal class RetractEvents : CashDispenserEvents, IRetractEvents
    {
        ...
        public async Task IncompleteRetractEvent(XFS4IoT.CashDispenser.Events.IncompleteRetractEvent.PayloadData Payload) => await connection.SendMessageAsync(new XFS4IoT.CashDispenser.Events.IncompleteRetractEvent(requestId, Payload));
