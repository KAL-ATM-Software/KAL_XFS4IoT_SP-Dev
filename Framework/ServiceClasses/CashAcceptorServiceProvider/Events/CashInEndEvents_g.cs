 ...
 * CashInEndEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class CashInEndEvents : CashAcceptorEvents, ICashInEndEvents
    {

        public CashInEndEvents(IConnection connection, int requestId)
