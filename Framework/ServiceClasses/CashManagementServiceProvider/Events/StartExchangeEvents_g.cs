 ...
 * StartExchangeEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class StartExchangeEvents : CashManagementEvents, IStartExchangeEvents
    {

        public StartExchangeEvents(IConnection connection, int requestId)
