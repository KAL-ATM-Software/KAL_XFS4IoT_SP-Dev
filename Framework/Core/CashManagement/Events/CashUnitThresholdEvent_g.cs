 ...
 * CashUnitThresholdEvent_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
namespace XFS4IoT.CashManagement.Events
{
    ...
    [DataContract]
    [Event(Name = "CashManagement.CashUnitThresholdEvent")]
    public sealed class CashUnitThresholdEvent : UnsolicitedEvent<CashUnitThresholdEvent.PayloadData>
    {

        public CashUnitThresholdEvent(PayloadData Payload)
            : base(Payload)
        { }
