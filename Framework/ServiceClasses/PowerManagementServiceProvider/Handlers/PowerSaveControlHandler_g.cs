...
{
    [CommandHandler(XFSConstants.ServiceClass.PowerManagement, typeof(PowerSaveControlCommand))]
    public partial class PowerSaveControlHandler : ICommandHandler
    {
        public PowerSaveControlHandler(IConnection Connection, ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            Provider.Device.IsNotNull($"Invalid parameter received in the {nameof(PowerSaveControlHandler)} constructor. {nameof(Provider.Device)}")
                           .IsA<IPowerManagementDevice>();

            PowerManagement = Provider.IsA<IPowerManagementService>();
        ...
        private IPowerManagementDevice Device { get => Provider.Device.IsA<IPowerManagementDevice>(); }
        private IServiceProvider Provider { get; }
        private IPowerManagementService PowerManagement { get; }
