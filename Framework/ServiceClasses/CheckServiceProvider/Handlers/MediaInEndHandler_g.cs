...
namespace XFS4IoTFramework.Check
{
    ...
    public partial class MediaInEndHandler : ICommandHandler
    {
        ...
        public async Task Handle(object command, CancellationToken cancel)
        {
            ...
            await Connection.SendMessageAsync(new MediaInEndCompletion(mediaInEndCmd.Header.RequestId.Value, result.Payload, result.CompletionCode, result.ErrorDescription));
        ...
        public async Task HandleError(object command, Exception commandException)
        {
            ...
            var response = new MediaInEndCompletion(mediaInEndCommand.Header.RequestId.Value, null, errorCode, commandException.Message);
