...
{
    [DataContract]
    [Completion(Name = "CashManagement.StartExchange")]
    public sealed class StartExchangeCompletion : Completion<StartExchangeCompletion.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            /// * ```cashUnitError``` - An error occurred with a cash unit while performing the exchange operation. A 
            /// CashManagement.CashUnitErrorEvent will be sent with the details.
            /// * ```tooManyItems``` - This error is generated if the contents of the recycle cash unit cannot be
            ///  completely emptied to the output position. The maximum possible number of items is moved to the 
            ///  output position.
