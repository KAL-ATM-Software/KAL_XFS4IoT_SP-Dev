 ...
 * GetCashUnitInfo_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    [DataContract]
    [Completion(Name = "CashManagement.GetCashUnitInfo")]
    public sealed class GetCashUnitInfoCompletion : Completion<GetCashUnitInfoCompletion.PayloadData>
    {
        public GetCashUnitInfoCompletion(int RequestId, GetCashUnitInfoCompletion.PayloadData Payload)
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            public PayloadData(CompletionCodeEnum CompletionCode, string ErrorDescription, Dictionary<string, CashunitsClass> Cashunits = null)
