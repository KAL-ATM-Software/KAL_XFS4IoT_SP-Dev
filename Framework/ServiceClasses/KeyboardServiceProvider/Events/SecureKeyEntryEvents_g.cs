 ...
 * SecureKeyEntryEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class SecureKeyEntryEvents : KeyboardEvents, ISecureKeyEntryEvents
    {

        public SecureKeyEntryEvents(IConnection connection, int requestId)
