...
{
    public sealed class ShutterStatusChangedCommandEvents : ItemInfoAvailableCommandEvent
    {
        public ShutterStatusChangedCommandEvents(IPresentEvents events) :
            base(events)
        { }
        public ShutterStatusChangedCommandEvents(IResetEvents events) :
            base(events)
        { }
        ...
        public Task ShutterStatusChangedEvent(CashManagementCapabilitiesClass.PositionEnum Position, CashManagementStatusClass.ShutterEnum Status)
        {
            ...
            {
                return PresentEvents.ShutterStatusChangedEvent(payload);
            }
