...
namespace XFS4IoT.Common.Completions
{
    ...
    public sealed class SetTransactionStateCompletion : Completion<SetTransactionStateCompletion.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            {
                ErrorDescription.IsNotNullOrWhitespace($"Null or an empty value for {nameof(ErrorDescription)} in received {nameof(SetTransactionStateCompletion.PayloadData)}");
