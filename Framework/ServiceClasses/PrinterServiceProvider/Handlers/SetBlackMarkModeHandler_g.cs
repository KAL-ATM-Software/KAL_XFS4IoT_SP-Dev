...
namespace XFS4IoTFramework.Printer
{
    ...
    public partial class SetBlackMarkModeHandler : ICommandHandler
    {
        ...
        public async Task HandleError(IConnection connection, object command, Exception commandException)
        {
            ...
            var response = new SetBlackMarkModeCompletion(setBlackMarkModecommand.Headers.RequestId, new SetBlackMarkModeCompletion.PayloadData(errorCode, commandException.Message));
