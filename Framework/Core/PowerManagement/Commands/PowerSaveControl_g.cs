...
namespace XFS4IoT.PowerManagement.Commands
{
    ...
    public sealed class PowerSaveControlCommand : Command<PowerSaveControlCommand.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            /// <summary>
            /// Specifies the maximum number of seconds in which the device must be able to return to its normal operating state when exiting the power-saving mode. The device will be set to the highest possible power save mode within this constraint. If set to 0 then the device will exit the power-saving mode.
            /// <example>5</example>
            /// </summary>
