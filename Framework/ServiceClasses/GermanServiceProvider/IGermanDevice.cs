...
{
    public interface IGermanDevice : IDevice
    {
        /// <summary>
        /// Returns the current HSM terminal data.
        /// </summary>
        Task<GetHSMTDataResponse> GetHSMTDataAsync(CancellationToken cancellation);
        ...
        /// </summary>
        Task<SetHSMTDataResponse> SetHSMTDataAsync(SetHSMTDataRequest request, CancellationToken cancellation);
        ...
        /// </summary>
        Task<SecureMsgSendResponse> SecureMsgSendAsync(SecureMsgSendRequest request, CancellationToken cancellation);
        ...
        /// state machine.
        /// </summary>
        Task<SecureMsgReceiveResponse> SecureMsgReceiveAsync(SecureMsgReceiveRequest request, CancellationToken cancellation);
        ...
        /// </summary>
        Task<HSMInitResponse> HSMInitAsync(HSMInitRequest request, CancellationToken cancellation);

        /// <summary>
        /// German specific capabilities
        /// </summary>
        GermanCapabilitiesClass GermanCapabilities { get; set; }
    }
}
