...
namespace XFS4IoT.Printer.Completions
{
    ...
    public sealed class ControlMediaCompletion : Completion<ControlMediaCompletion.PayloadData>
    {
        ...
        public sealed class PayloadData : MessagePayload
        {
            ...
            {
                ErrorDescription.IsNotNullOrWhitespace($"Null or an empty value for {nameof(ErrorDescription)} in received {nameof(ControlMediaCompletion.PayloadData)}");
            ...
            ////  The control action could not be completed because there is no media in the device, the media is not  in a position where it can be controlled, or (in the case of **retract**) has been removed.**flushFail**
            ...
            ////  Programming error. Invalid command sequence (e.g. *park* and the parking station is busy).**mediaRetained**
