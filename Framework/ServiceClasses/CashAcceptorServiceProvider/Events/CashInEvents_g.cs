 ...
 * CashInEvents_g.cs uses automatically generated parts.
\***********************************************************************************************/
...
{
    internal class CashInEvents : CashAcceptorEvents, ICashInEvents
    {

        public CashInEvents(IConnection connection, int requestId)
        ...
        public async Task SubCashInEvent(XFS4IoT.CashAcceptor.Events.SubCashInEvent.PayloadData Payload) => await connection.SendMessageAsync(new XFS4IoT.CashAcceptor.Events.SubCashInEvent(requestId, Payload));
