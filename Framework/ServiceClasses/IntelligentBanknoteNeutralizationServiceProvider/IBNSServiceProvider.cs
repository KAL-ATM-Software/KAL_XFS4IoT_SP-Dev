...
namespace XFS4IoTServer
{
    ...
    /// </summary>
    public class IBNSServiceProvider : ServiceProvider, IIntelligentBanknoteNeutralizationService, ICommonService, IStorageService
    {
        public IBNSServiceProvider(
            ...
            base(endpointDetails,
                 ServiceName,
                 [ XFSConstants.ServiceClass.Common, XFSConstants.ServiceClass.IntelligentBanknoteNeutralization ],
                 device,
                 logger)
        {
