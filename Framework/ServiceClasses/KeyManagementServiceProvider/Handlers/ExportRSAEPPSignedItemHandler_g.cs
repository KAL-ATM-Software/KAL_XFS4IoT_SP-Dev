...
namespace XFS4IoTFramework.KeyManagement
{
    ...
    {
        public ExportRSAEPPSignedItemHandler(IConnection Connection, ICommandDispatcher Dispatcher, ILogger logger)
        {
            ...
            this.Connection = Connection.IsNotNull($"Invalid parameter in the {nameof(ExportRSAEPPSignedItemHandler)} constructor. {nameof(Connection)}");
        }
