...
namespace XFS4IoTFramework.VendorMode
{
    ...
    public partial class RegisterHandler : ICommandHandler
    {
        ...
        public async Task Handle(object command, CancellationToken cancel)
        {
            ...
            await Connection.SendMessageAsync(new RegisterCompletion(registerCmd.Header.RequestId.Value, result.CompletionCode, result.ErrorDescription));
        ...
        public async Task HandleError(object command, Exception commandException)
        {
            ...
            var response = new RegisterCompletion(registerCommand.Header.RequestId.Value, errorCode, commandException.Message);
